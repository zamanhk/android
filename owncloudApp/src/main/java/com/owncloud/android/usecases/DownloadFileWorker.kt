...
import com.owncloud.android.extensions.showNotificationWithProgress
...
class DownloadFileWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        val ocFile = localFileDataSource.getFile(fileId)
    ...
    private val savePathForFile: String
        get() =
            ...
            ocFile.storagePath.takeUnless { it.isNullOrBlank() }
                ?: FileStorageUtils.getDefaultSavePathFor(accountName, ocFile.remotePath)
    ...
    override fun onTransferProgress(
        ...
        showNotificationWithProgress(
            ...
            notificationChannelId = NOTIFICATION_CHANNEL_ID_DOWNLOADS,
